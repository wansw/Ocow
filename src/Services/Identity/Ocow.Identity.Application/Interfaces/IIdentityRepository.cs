...
public interface IIdentityRepository
{
    ...
    /// 查询指定管理员按权限点可见的菜单列表。
    /// </summary>
    Task<IReadOnlyList<Menu>> GetAdminMenusAsync(Guid adminUserId, CancellationToken cancellationToken = default);

    /// <summary>
    /// 保存菜单。
    /// </summary>
    Task<Menu> SaveMenuAsync(Menu menu, CancellationToken cancellationToken = default);
